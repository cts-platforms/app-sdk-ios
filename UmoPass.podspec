Pod::Spec.new do |spec|
  ...
  spec.source       = { :git => 'https://github.com/cts-platforms/app-sdk-ios.git', :tag => 'UmoPass-0.3.1-beta1' }
  spec.vendored_frameworks = 'UmoPass/UmoPass.xcframework'
  spec.framework    = 'SystemConfiguration'
  spec.swift_version = '5.0'
  spec.ios.deployment_target = '12.0'
  spec.dependency 'CubicAuth', :path => '../CubicAuth/CubicAuth/CubicAuth.podspec'#, '~> 1.3'
